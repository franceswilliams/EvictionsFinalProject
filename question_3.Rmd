...
<!-- $$ -->
<!-- (1) \hspace{20mm} log\{E({Y_{ij})}\} = log(n_{ij}) + \beta_0 + \beta_1*year_{ij} + \beta_2*X_{ij} \\ -->
<!-- \hspace{20mm}\\ -->
...
univariate_poi = function(x){
  ...
  gee_poi = geeglm(evictions ~ 
                   ...
                   offset(log(renter_occupied_households/100)) + x + years_since_2010, ## here i removed the int term
...
__Next Steps__
  ...
  * Compare models to saturated models
