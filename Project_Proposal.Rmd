...
* For gentrification measures: (https://www.governing.com/gov-data/new-york-gentrification-maps-demographic-data.html)

* For dissimilarity indices, English language usage, population change: (https://factfinder.census.gov/faces/nav/jsf/pages/guided_search.xhtml)
