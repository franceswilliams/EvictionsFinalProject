...
**Intended final products:** A website providing an overview of eviction metrics by c
ensus tracts, as well as interactive maps illustrating the relationship between neighborhood-level variables and eviction rates. 
...
### The planned analyses, visualizations, and coding challenges:
  ...
  * Analyses: Regressions of the following factors on two outcomes: 1) Eviction rates, and 2) Eviction filings
